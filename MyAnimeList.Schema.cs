...
namespace sunshine
{
    ...
    internal class AnimeDetailed : Anime
    {
        ...
        [JsonProperty("title_synonyms")] public string[] TitleSynonyms;
        ...
        [JsonProperty("genres")] public MyAnimeListObject[] Genres;
        [JsonProperty("studios")] public AnimeStudio[] Studios;
    }
